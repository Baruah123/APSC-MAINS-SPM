    ...
    <div className="w-full max-w-2xl bg-white rounded-xl shadow-sm border border-gray-100 p-8 text-center animate-in zoom-in-95 duration-500">
      ...
      <div className="text-gray-600 mb-8 space-y-3 text-lg">
        ...
        <div className="flex justify-center items-center gap-3 mt-4">
          <a href="https://wa.me/917996112300" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-green-50 text-green-700 font-semibold rounded-lg hover:bg-green-100 transition-colors border border-green-200">
